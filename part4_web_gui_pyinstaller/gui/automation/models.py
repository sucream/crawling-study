...
class Category(BaseModel):
    ...
    def __repr__(self):
        return f"<Category(id={self.id}, main_section={self.main_section}, sub_section={self.sub_section}, category_name={self.category_name}, num_of_news={len(self.news_list)})>"
